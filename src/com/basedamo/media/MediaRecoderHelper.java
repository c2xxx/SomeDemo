...
public class MediaRecoderHelper {
    ...
    private MediaRecoderHelper(String dir) {
        mDirString = dir;
    }

    public static MediaRecoderHelper getInstance(String dir) {
        if (mInstance == null) {
            synchronized (MediaRecoderHelper.class) {
                if (mInstance == null) {
                    mInstance = new MediaRecoderHelper(dir);
